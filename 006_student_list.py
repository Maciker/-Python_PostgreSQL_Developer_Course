...
def print_student_details(student):
    print("{}, average mark: {}.".format(student.name,student.average_marks()))
...
def menu():
    selection = input("Enter 'p' to print a student list"
    ...
    while selection != 'q':
        if selection == 'p':
            ...
            student_id = int(input("Enter the student ID to add a mark too: "))
